...
import random
import my_module
# ERROR:: ModuleNotFoundError: No module named 'my_module.py'; 'my_module' is not a package
random_int = random.randint(1,10)

print(random_int)

# Modules - Different reusable part for a single application

print(my_module.my_favourite_number)

random_float = random.random() # generate random decimal b/w 0 (Include 0 ) and 1 (exclusive 1 )
...
if round(random_float_number) >= 5:
    print("Heads")
else:
    print("Tails")
